...
//            Console.WriteLine("C - Convert file for loading");
...
//        {
//            string fileName = "";
//            Console.WriteLine("Enter the file name you want to convert");
//            fileName = Console.ReadLine();
//            StreamReader reader = new StreamReader(fileName + ".txt");
//            string secondLine = "";
//            string firstline = reader.ReadLine(); // get the name still to add width and height
...
//                secondLine = secondLine + lineFromFile;
//                // add 1 to the height
//                height++;
//            }
//            reader.Close();
//            // write the first line with name,width,height,A
//            firstline = firstline + $",{width},{height},A";
//            StreamWriter writer = new StreamWriter("Conv" + fileName + ".txt");
